...
export default function EscolhaDeEntrada() {
    ...
    return (
        <Caixa>
            <h1 style={{ margin: "0 0 4px 0" }}>Helpdesk</h1>
            ...
            <Coluna>
                ...
                <Botao $larguraTotal onClick={iniciarComoVisitante} style={{ background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.1)' }}>
                    <BtnContent>
                        <FaTicketAlt size={18} />
